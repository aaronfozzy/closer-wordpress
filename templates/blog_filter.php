<section class="filter-wrap">
	<div id="filters">
		<div class="inner">
			<form class="news-blog-filter filter flex jc-start" action="<?php echo get_option('home'); ?>/news-opinion/blog/" method="get">	
					...
					<select name="filt_work" id="filt_work">
						...
						<?php 
							...
							foreach ($blog_areas_of_works as $blog_areas_of_work) {
								echo '<option value="'.$blog_areas_of_work->slug.'">'.$blog_areas_of_work->name.'</option>';
							} ?>
					</select>
				</div>
