...
function filter_menu_items($item) {
        ...
        $item->title = '<div class="li_wrapper">
        <div class="li_image">'
        	.$menu_image .'
    	</div>
        <div class="li_title_wrapper">
        	<div class="li_title">'. $item->title .'</div>
        	<div class="li_title_desc">' .$item->description .'</div>
        </div>
        </div>';
                ...
                <div class="post_wrapper">
                    ...
                    <div class="post_content">
                       ...
                       <?php if (is_post_type_archive('blog')) { ?>
                          <div class="post_by_line">by:  <span><?php the_field('the_author'); ?></span></div>
                       <?php } ?>
