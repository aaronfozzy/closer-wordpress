...
// 	}
	...
	// Any templates with a jump links sidebar
	if ( is_singular( 'evidence' ) ) {
		$classes[] = 'has-jls';
	}

	// Events listings
	if ( in_array( get_page_template_slug(), array( 'page_events.php', 'page_events-previous.php' ) ) ) {
		$classes[] = 'events-listing';
	}

	// Data resource / Evidence impact landing
	if ( in_array( get_page_template_slug(), array( 'page_data-resources.php', 'page_evidence-impact.php' ) ) ) {
		$classes[] = 'data-evidence-landing';
	}
