...
<div id="content" role="main">
	...
	<?php require( dirname( __FILE__ ) . '/templates/news_filter.php' ); ?>
			...
			<div id="posts" class="indent wrapper limit-width blog_news">
				<div class="flex col-2">
					...
					if (  $wp_query->max_num_pages > 1 )
						echo '<a class="button load_more_bt more_rec"><span class="icon icon-angle-circled-down"></span>Load more</a>'; // you can use <a> as well
					?>
				</div>
			</div>
		</div>
